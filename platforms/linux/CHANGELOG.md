...
## [0.13.0](https://github.com/whiskerrs/whisker/compare/whisker-linux-v0.12.0...whisker-linux-v0.13.0) - 2026-09-03

### Added

- *(desktop)* align os shell hot reload APIs
...
- *(linux)* dynamically load Wayland client
