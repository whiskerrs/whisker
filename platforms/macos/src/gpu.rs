...
use whisker_protocol::{
    BorderLineStyle, BoxPaint, LayoutRect, NodeId, PaintColor, PaintLengthPercentage,
};
...
fn push_quad(vertices: &mut Vec<BoxVertex>, rect: LayoutRect, color: [f32; 4]) {
    ...
    for position in [
        ...
        vertices.push(BoxVertex { position, color });
    }
}
