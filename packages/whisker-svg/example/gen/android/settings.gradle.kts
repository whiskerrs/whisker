...
dependencyResolutionManagement {
    ...
    repositories {
        ...
        flatDir {
            dirs("/Users/itome/Projects/github.com/whiskerrs/whisker/target/lynx-android")
        }
    }
}

rootProject.name = "whisker-svg-example-android"
include(":app")
include(":module")
project(":module").projectDir = file("/Users/itome/Projects/github.com/whiskerrs/whisker/platforms/android/module")
include(":whisker-runtime")
project(":whisker-runtime").projectDir = file("/Users/itome/Projects/github.com/whiskerrs/whisker/platforms/android/whisker-runtime")
...
includeBuild("/Users/itome/Projects/github.com/whiskerrs/whisker/platforms/android/ksp")
