...
/// `-sys` proxy for the WhiskerLocalStore native module.
///
...
///
/// Hand-written wrapper on top of [`WhiskerLocalStoreSys`] —
...
impl WhiskerLocalStore {
    ...
    pub fn save(key: String, value: String) -> Result<bool, WhiskerModuleError> {
        let result = WhiskerLocalStoreSys::save(vec![
    ...
    pub fn load(key: String) -> Result<Option<String>, WhiskerModuleError> {
        let result = WhiskerLocalStoreSys::load(vec![WhiskerValue::String(key)]);
        match result {
    ...
    pub fn remove(key: String) -> Result<(), WhiskerModuleError> {
        let result = WhiskerLocalStoreSys::remove(vec![WhiskerValue::String(key)]);
        match result {
