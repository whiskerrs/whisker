...
//!      `#[whisker::platform_module(name = "...")]`. Every method
...
//!      [`whisker::platform_module::invoke`] verbatim.
//!
...
///
/// Generated by `#[whisker::platform_module]` — every method is a
/// thin pass-through that calls
/// `whisker::platform_module::invoke("WhiskerLocalStore", method, args)`.
