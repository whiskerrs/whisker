 ...
 * `@WhiskerElement("LocalTag")`- AND `@WhiskerModule("Name")`-
...
public class WhiskerElementProcessor(
    ...
    private fun writeBehavioursFile(
        ...
        codeGenerator.createNewFile(
            ...
            w.appendLine("//")
            w.appendLine("// Sourced from `@WhiskerElement(\"LocalTag\")` and")
            w.appendLine("// `@WhiskerModule(\"Name\")` applications in this Whisker")
            w.appendLine("// module subproject. Each @WhiskerElement is registered with")
            ...
            // @WhiskerElement class that carries @WhiskerProp setters
