...
//! `TUFT_REAL_LINKER` (what the linker shim forwards to during the
...
/// NDK versions we know work with Tuft, in preference order.
...
/// `Builder::with_capture` (as `TUFT_REAL_LINKER`) and the
