...
use whisker_cng::plugins::android_meta_data::AndroidMetaDataConfig;
use whisker_cng::plugins::android_permissions::AndroidPermissionsConfig;
use whisker_cng::plugins::info_plist_extra::InfoPlistExtraConfig;
...
fn ios_info_plist_extra_keys_reach_the_rendered_plist() {
    ...
    app.plugin::<InfoPlistExtraConfig>(|c| {
...
fn android_extra_permissions_reach_the_rendered_manifest() {
    ...
    app.plugin::<AndroidPermissionsConfig>(|c| {
...
fn android_meta_data_reaches_the_rendered_manifest_inside_application() {
    let mut app = base_android_app();
    app.plugin::<AndroidMetaDataConfig>(|c| {
