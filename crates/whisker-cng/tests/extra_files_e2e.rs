...
use whisker_cng::plugins::android_extra_files::AndroidExtraFilesConfig;
use whisker_cng::plugins::ios_extra_files::IosExtraFilesConfig;
...
fn ios_extra_file_lands_at_the_declared_relative_path() {
    ...
    app.plugin::<IosExtraFilesConfig>(|c| {
...
fn android_extra_file_lands_at_the_declared_relative_path() {
    ...
    app.plugin::<AndroidExtraFilesConfig>(|c| {
