...
//!
//! Both `lyra_build::compile()` (per-crate build.rs) and `xtask`
...
/// Absolute path to the Lyra workspace root.
///
/// `CARGO_MANIFEST_DIR` resolves to `<workspace>/crates/lyra-build`
...
pub fn workspace_root() -> PathBuf {
    ...
    manifest
        ...
        .expect("lyra-build manifest dir has no grandparent")
        .to_path_buf()
}
