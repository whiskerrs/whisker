...
enum { WHISKER_MOBILE_ABI_MAJOR = 2, WHISKER_MOBILE_ABI_MINOR = 28 };
...
enum {
  ...
  WHISKER_OP_TEXT_STYLE, WHISKER_OP_ACCESSIBILITY
};
enum {
...
typedef struct {
  ...
  uint8_t child_policy, measurement, text_style, _pad;
  WhiskerStringRef name;
