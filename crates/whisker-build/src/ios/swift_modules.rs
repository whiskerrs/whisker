...
pub(super) fn parse_ios_platform_major(manifest: &str) -> Option<u32> {
...
/// dependency.
pub(super) fn render_modules_package_swift(
...
pub(super) fn render_register_all_swift(modules: &[&crate::modules::ResolvedModule]) -> String {
    let mut out = String::new();
    out.push_str(
        "// AUTO-GENERATED by whisker-build. Do NOT edit — re-run\n\
         // `whisker run` to refresh.\n\
