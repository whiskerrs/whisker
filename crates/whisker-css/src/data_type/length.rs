//! `<length>` — a distance.
//!
//! Whisker supports renderer-independent units shared by every Host:
//!
...
//!
//! Physical-pixel and platform-specific responsive units are intentionally
//! absent. Use logical pixels or viewport-relative units.
...
impl Length {
    ...
    pub fn is_zero(self) -> bool {
        match self {
            Length::Zero => true,
            Length::Px(v) | Length::Em(v) | Length::Rem(v) | Length::Vh(v) | Length::Vw(v) => {
                v == 0.0
            }
        }
    }
