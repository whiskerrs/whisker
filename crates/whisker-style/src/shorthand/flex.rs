...
mod tests {
    ...
    #[test]
    fn flex_none() {
        let s = Style::new().flex(Flex::None);
        assert_eq!(
            s.to_string(),
    ...
    #[test]
    fn flex_auto() {
        let s = Style::new().flex(Flex::Auto);
        assert_eq!(
            s.to_string(),
    ...
    #[test]
    fn flex_initial() {
        let s = Style::new().flex(Flex::Initial);
        assert_eq!(
            s.to_string(),
    ...
    #[test]
    fn flex_number() {
        let s = Style::new().flex(Flex::Number(2.0));
        assert_eq!(
            s.to_string(),
    ...
    #[test]
    fn flex_full_triple() {
        let s = Style::new().flex(Flex::Full {
            grow: 1.5,
            shrink: 0.5,
    ...
    fn flex_then_grow_override() {
        let s = Style::new().flex(Flex::Auto).flex_grow(3.0);
        assert_eq!(
            s.to_string(),
