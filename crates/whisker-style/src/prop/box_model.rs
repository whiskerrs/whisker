...
mod tests {
    ...
    fn width_height_basic() {
        let s = Style::new().width(px(100)).height(50.percent());
    ...
    fn box_sizing_keyword() {
        let s = Style::new().box_sizing(BoxSizing::BorderBox);
        assert_eq!(s.to_string(), "box-sizing: border-box;");
    }

    #[test]
    fn aspect_ratio_pair() {
        let s = Style::new().aspect_ratio(16.0, 9.0);
