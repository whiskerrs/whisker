...
mod tests {
    ...
    #[test]
    fn display_keyword() {
        let s = Style::new().display(Display::Flex);
        assert_eq!(s.to_string(), "display: flex;");
    }

    #[test]
    fn display_shortcuts() {
        assert_eq!(Style::new().display_none().to_string(), "display: none;");
        assert_eq!(Style::new().display_flex().to_string(), "display: flex;");
        assert_eq!(Style::new().display_grid().to_string(), "display: grid;");
        assert_eq!(
            Style::new().display_linear().to_string(),
            "display: linear;"
        );
        assert_eq!(
            Style::new().display_relative().to_string(),
            "display: relative;"
        );
    }
    ...
    fn direction_keywords() {
        assert_eq!(Style::new().direction(Direction::Ltr).to_string(), "direction: ltr;");
        assert_eq!(Style::new().direction(Direction::Rtl).to_string(), "direction: rtl;");
    }
}
