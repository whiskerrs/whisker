...
impl Style {
    ...
    /// [`Style::raw`] escape hatch with a comma-separated list.
...
mod tests {
    ...
    fn font_family_quotes_the_value() {
        let s = Style::new().font_family("Helvetica Neue");
    ...
    fn font_size_length_or_percentage() {
        assert_eq!(
            Style::new().font_size(px(16)).to_string(),
            "font-size: 16px;"
        );
        assert_eq!(
            Style::new().font_size(percent(120)).to_string(),
            "font-size: 120%;"
        );
    }
    ...
    fn font_style_keywords() {
        assert_eq!(
            Style::new().font_style(FontStyle::Italic).to_string(),
            "font-style: italic;"
        );
    }
    ...
    fn font_weight_keyword_and_numeric() {
        assert_eq!(
            Style::new().font_weight(FontWeight::Bold).to_string(),
            "font-weight: bold;"
        );
        assert_eq!(
            Style::new().font_weight(FontWeight::Numeric(600)).to_string(),
            "font-weight: 600;"
        );
    }
    ...
    fn font_variant_small_caps() {
        assert_eq!(
            Style::new().font_variant(FontVariant::SmallCaps).to_string(),
    ...
    fn letter_spacing_length() {
        let s = Style::new().letter_spacing(px(2).into());
    ...
    fn line_height_variants() {
        assert_eq!(
            Style::new().line_height(LineHeight::Normal).to_string(),
            "line-height: normal;"
        );
        assert_eq!(
            Style::new().line_height(1.5_f32).to_string(),
            "line-height: 1.5;"
        );
        assert_eq!(
            Style::new().line_height(px(24)).to_string(),
            "line-height: 24px;"
        );
        assert_eq!(
            Style::new().line_height(percent(150)).to_string(),
            "line-height: 150%;"
        );
    }
}
