...
mod tests {
    ...
    #[test]
    fn background_color() {
        let s = Style::new().background_color(Color::Named(NamedColor::Black));
        assert_eq!(s.to_string(), "background-color: black;");
    }

    #[test]
    fn foreground_color() {
        let s = Style::new().color(Color::Named(NamedColor::White));
        assert_eq!(s.to_string(), "color: white;");
    }

    #[test]
    fn background_image_url() {
        let s = Style::new().background_image(ImageRef::Url(CssString::new("a.png")));
    ...
    fn background_image_gradient() {
        ...
        let s = Style::new().background_image(g);
        assert_eq!(
            s.to_string(),
    ...
    fn background_image_none() {
        let s = Style::new().background_image(ImageRef::None);
    ...
    fn background_size_keywords() {
        let s = Style::new().background_size(BackgroundSize::Cover);
        assert_eq!(s.to_string(), "background-size: cover;");
        let s = Style::new().background_size(BackgroundSize::Contain);
        assert_eq!(s.to_string(), "background-size: contain;");
        let s = Style::new().background_size(BackgroundSize::Auto);
    ...
    fn background_attachment() {
        let s = Style::new().background_attachment(BackgroundAttachment::Fixed);
