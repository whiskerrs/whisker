...
mod tests {
    ...
    const ALL: &[NamedColor] = &[
        NamedColor::AliceBlue, NamedColor::AntiqueWhite, NamedColor::Aqua,
        NamedColor::Aquamarine, NamedColor::Azure, NamedColor::Beige,
        NamedColor::Bisque, NamedColor::Black, NamedColor::BlanchedAlmond,
        NamedColor::Blue, NamedColor::BlueViolet, NamedColor::Brown,
        NamedColor::BurlyWood, NamedColor::CadetBlue, NamedColor::Chartreuse,
        NamedColor::Chocolate, NamedColor::Coral, NamedColor::CornflowerBlue,
        NamedColor::Cornsilk, NamedColor::Crimson, NamedColor::Cyan,
        NamedColor::DarkBlue, NamedColor::DarkCyan, NamedColor::DarkGoldenRod,
        NamedColor::DarkGray, NamedColor::DarkGreen, NamedColor::DarkGrey,
        NamedColor::DarkKhaki, NamedColor::DarkMagenta, NamedColor::DarkOliveGreen,
        NamedColor::DarkOrange, NamedColor::DarkOrchid, NamedColor::DarkRed,
        NamedColor::DarkSalmon, NamedColor::DarkSeaGreen, NamedColor::DarkSlateBlue,
        NamedColor::DarkSlateGray, NamedColor::DarkSlateGrey, NamedColor::DarkTurquoise,
        NamedColor::DarkViolet, NamedColor::DeepPink, NamedColor::DeepSkyBlue,
        NamedColor::DimGray, NamedColor::DimGrey, NamedColor::DodgerBlue,
        NamedColor::FireBrick, NamedColor::FloralWhite, NamedColor::ForestGreen,
        NamedColor::Fuchsia, NamedColor::Gainsboro, NamedColor::GhostWhite,
        NamedColor::Gold, NamedColor::GoldenRod, NamedColor::Gray,
        NamedColor::Green, NamedColor::GreenYellow, NamedColor::Grey,
        NamedColor::HoneyDew, NamedColor::HotPink, NamedColor::IndianRed,
        NamedColor::Indigo, NamedColor::Ivory, NamedColor::Khaki,
        NamedColor::Lavender, NamedColor::LavenderBlush, NamedColor::LawnGreen,
        NamedColor::LemonChiffon, NamedColor::LightBlue, NamedColor::LightCoral,
        NamedColor::LightCyan, NamedColor::LightGoldenRodYellow, NamedColor::LightGray,
        NamedColor::LightGreen, NamedColor::LightGrey, NamedColor::LightPink,
        NamedColor::LightSalmon, NamedColor::LightSeaGreen, NamedColor::LightSkyBlue,
        NamedColor::LightSlateGray, NamedColor::LightSlateGrey, NamedColor::LightSteelBlue,
        NamedColor::LightYellow, NamedColor::Lime, NamedColor::LimeGreen,
        NamedColor::Linen, NamedColor::Magenta, NamedColor::Maroon,
        NamedColor::MediumAquaMarine, NamedColor::MediumBlue, NamedColor::MediumOrchid,
        NamedColor::MediumPurple, NamedColor::MediumSeaGreen, NamedColor::MediumSlateBlue,
        NamedColor::MediumSpringGreen, NamedColor::MediumTurquoise, NamedColor::MediumVioletRed,
        NamedColor::MidnightBlue, NamedColor::MintCream, NamedColor::MistyRose,
        NamedColor::Moccasin, NamedColor::NavajoWhite, NamedColor::Navy,
        NamedColor::OldLace, NamedColor::Olive, NamedColor::OliveDrab,
        NamedColor::Orange, NamedColor::OrangeRed, NamedColor::Orchid,
        NamedColor::PaleGoldenRod, NamedColor::PaleGreen, NamedColor::PaleTurquoise,
        NamedColor::PaleVioletRed, NamedColor::PapayaWhip, NamedColor::PeachPuff,
        NamedColor::Peru, NamedColor::Pink, NamedColor::Plum,
        NamedColor::PowderBlue, NamedColor::Purple, NamedColor::RebeccaPurple,
        NamedColor::Red, NamedColor::RosyBrown, NamedColor::RoyalBlue,
        NamedColor::SaddleBrown, NamedColor::Salmon, NamedColor::SandyBrown,
        NamedColor::SeaGreen, NamedColor::SeaShell, NamedColor::Sienna,
        NamedColor::Silver, NamedColor::SkyBlue, NamedColor::SlateBlue,
        NamedColor::SlateGray, NamedColor::SlateGrey, NamedColor::Snow,
        NamedColor::SpringGreen, NamedColor::SteelBlue, NamedColor::Tan,
        NamedColor::Teal, NamedColor::Thistle, NamedColor::Tomato,
        NamedColor::Turquoise, NamedColor::Violet, NamedColor::Wheat,
        NamedColor::White, NamedColor::WhiteSmoke, NamedColor::Yellow,
