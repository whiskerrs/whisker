...
/// with `WhiskerElementTag` in `crates/whisker-driver-sys/bridge/include/whisker_bridge.h`.
#[repr(u32)]
...
/// One node in a Whisker element tree. Trees are entirely owned (no
...
mod tests {
    ...
    fn tag_repr_matches_bridge_constants() {
        ...
        // crates/whisker-driver-sys/bridge/include/whisker_bridge.h.
